        ...
        <div className="">
          ...
          {showData && (
            <div className="absolute left-0 mt-5 w-full  bg-white  shadow-lg rounded-md py-2">
              ...
              <p className="bg-white border-b border-gray-400 p-3">Sub menu1</p>
              <p className="bg-white border-b border-gray-400 p-3">Sub menu2</p>
              <p className="bg-white  p-3">Sub menu3</p>
            </div>
          )}
        </div>
      </div>
