    ...
    <div>
      <div className="bg-gradient-to-r from-[#c9252c45] to-[#ffbc004a] flex items-center justify-center">
        <div className="grid grid-cols-2 p-[3%] max-[1000px]:grid-cols-1">
          ...
          <div className="bg-gradient-to-r px-[10%] max-[1000px]:py-9 from-[#930f14] to-[#FFBC00] text-white flex flex-col items-center justify-center h-full">
...
export default RegistrationForgotpw;
